        ...
        <div class="col-md-8 col-md-offset-2">
          <a href="{{route('fournisseurs.index')}}">
            ...
            <div class="panel panel-default">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ route('fournisseurs.store') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('nom') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="nom" type="text" class="form-control" name="nom" value="{{ old('nom') }}" placeholder="Fournisseur" required>
                    ...
                    <div class="form-group{{ $errors->has('numTel') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="numTel" type="number" class="form-control" name="numTel" value="{{ old('numTel') }}" placeholder="Mobile">
