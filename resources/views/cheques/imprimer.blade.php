    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
          ...
          body {background:white;
             font-size:10pt;
             margin:0; }
          #anotherDiv,.button { display:none; }
              ...
              //   window.print();
                      ...
                      /*optional stylesheet*/
                myWindow.document.write('<link href="{{ asset('css/print.css') }}" rel="stylesheet">');
          ...
          <body>
              <div   id="myDiv">
                <div class="cheque">
                  ...
                  <p class="chiffre">{{$cheque->montantChiffre}}DT</p>
                  <p class="lettre"><br>{{$cheque->montantLettre}}<br>Paiement de fournisseur {{$fournisseur->nom}}</p>

                  <p class="lieu">{{Auth::user()->lieu}}</p>
                  <p class="date">{{$cheque->dateEcheance}}</p>
                </div>
              </div>
              <div id="anotherDiv">
