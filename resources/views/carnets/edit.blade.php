        ...
        <div class="col-md-8 col-md-offset-2">
          <a href="{{route('carnets.index')}}">
            ...
            <div class="panel panel-default">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ route('carnets.update',$carnet->id) }}">
                  <input type="hidden" name="_method" value="PUT">
                    ...
                    <div class="form-group{{ $errors->has('numCarnet') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="numCarnet" type="number" class="form-control" name="numCarnet" value="{{ $carnet->numCarnet }}" placeholder="Numéro De Carnet" required  autofocus>
                    ...
                    <div class="form-group{{ $errors->has('numFeuilleDebut') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="numFeuilleDebut" type="number" class="form-control" name="numFeuilleDebut" value="{{ $carnet->numFeuilleDebut }}" placeholder="Numéro De Première Feuille" required>
                    ...
                    <div class="form-group{{ $errors->has('numFeuilles') ? ' has-error' : '' }}">
                        <label for="numFeuilles" class="col-md-4 control-label"></label>

                        <div class="col-md-6">
                            <input id="numFeuilles" type="number" class="form-control" name="numFeuilles" value="{{ $carnet->numFeuilles }}" placeholder="Numéro Des Feuilles" required>
